  ...
  return (
    <div className="app__intro" id='home'>
        ...
        <div className="app__intro-content">
            ...
            Additionally, the webpage includes personal information about me, the designer, to provide
            potential employers with an insight into my background and qualifications.</p>
        </div>
    </div>
  )
}
